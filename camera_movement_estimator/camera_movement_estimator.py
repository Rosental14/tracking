...
import sys
sys.path.append('../')
from utils.bbox_utils import measure_xy_distance, measure_distance
...
class CameraMovementEstimator():
    ...
    def __init__(self, frame):
        ...
        mask_features[:, 0:180] = 1
        mask_features[:, 970:1050] = 1
    ...
    def draw_camera_movement(self, frame, camera_movement_per_frame):
        ...
        for frame_num, frame in enumerate(frame):
            ...
            overlay = frame.copy()
            cv2.rectangle(overlay, (0,0), (450,70), (255,255,255), -1)
            alpha = 0.4
